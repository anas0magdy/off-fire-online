...
const HomePage = () => {
  ...
  return (
    <div className="animate-fadeIn" dir={isEn ? 'ltr' : 'rtl'}>
          ...
          return (
            <>
              ...
              <motion.div 
                ...
                initial="hidden"
                animate="visible"
                className="relative z-20 flex flex-col items-center text-center px-4 container mx-auto"
              >
                ...
                <motion.div variants={fadeInUp} className="w-full max-w-2xl flex flex-col sm:flex-row gap-4 justify-center items-center">
                  <Link to={getLocalizedPath('/contact')} className="w-full sm:w-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-20 items-center">
            ...
            >
              ...
              <motion.ul variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }} className="space-y-5 lg:space-y-8 mb-8 lg:mb-12">
                {FEATURES.map((feat, i) => (
                  <motion.li variants={fadeInUp} key={i} className="flex items-start gap-3 lg:gap-5 group">
            ...
            <motion.div 
              ...
              className="relative group hidden md:block order-1 md:order-2"
            >
      ...
      {/* 5. Services Summary */}
      <section className="py-12 lg:py-28 bg-dark overflow-hidden">
        <div className="container mx-auto px-4 lg:px-6">
          <motion.div 
          ...
          >
            ...
            <p className="text-text-sub text-lg lg:text-xl text-center max-w-4xl mx-auto">
            ...
            >
                ...
                <div key={service.id} className="bg-card p-5 lg:p-8 rounded-2xl border border-white/5 min-w-[85vw] sm:min-w-[45vw] lg:min-w-0 snap-center hover:border-primary transition-all group flex flex-col text-start">
                    <div className="mb-4 lg:mb-8 overflow-hidden rounded-xl h-48 lg:h-48 shadow-lg relative">
                        <img src={service.image} alt={service.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" onError={(e) => e.target.style.display = 'none'} />
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="mt-10 lg:mt-16 text-center">
      ...
      <section className="py-16 lg:py-28 relative bg-dark">
        <div className="absolute inset-0 z-0">
            <img src={SECTORS_BG_IMAGE} alt="" className="w-full h-full object-cover opacity-30" />
        ...
        <div className="container mx-auto px-4 lg:px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-20">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="text-start">
                <motion.h3 variants={fadeInUp} className={`text-2xl lg:text-3xl font-bold text-text-main mb-6 lg:mb-10 ${isEn ? 'border-l-4 pl-3 lg:pl-6' : 'border-r-4 pr-3 lg:pr-6'} border-cta text-start`}>
                ...
                <div className="grid grid-cols-2 gap-3 lg:gap-6">
                    {TARGET_AUDIENCE.map((aud, i) => (
                        <motion.div variants={fadeInUp} key={i} className="bg-card/50 backdrop-blur-sm p-4 lg:p-8 rounded-xl lg:rounded-2xl border border-white/5 hover:border-white/20 transition-colors text-start">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="mt-8 lg:mt-0 text-start">
                <motion.h3 variants={fadeInUp} className={`text-2xl lg:text-3xl font-bold text-text-main mb-6 lg:mb-10 ${isEn ? 'border-l-4 pl-3 lg:pl-6' : 'border-r-4 pr-3 lg:pr-6'} border-primary text-start`}>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-1 gap-3 lg:gap-6">
                    {WHY_US.slice(0,4).map((item, i) => (
                        <motion.div variants={fadeInUp} key={i} className="flex flex-col lg:flex-row items-start gap-2 lg:gap-6 bg-card/50 backdrop-blur-sm p-4 lg:p-6 rounded-xl border border-white/5 text-start hover:border-white/20 transition-colors">
      ...
      {/* 7. Provider Banner */}
      <section className="bg-gradient-to-r from-[#0f172a] via-[#1e293b] to-[#0f172a] border-y border-white/10 py-6 lg:py-8 relative z-20 overflow-hidden">
        <motion.div 
           initial="hidden" whileInView="visible" viewport={{ once: true }} variants={scaleIn}
           className="container mx-auto px-4 lg:px-6 flex flex-col md:flex-row items-center justify-between gap-6"
        >
          <div className="flex flex-col md:flex-row items-center gap-4 text-start w-full">
            <div className="w-14 h-14 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center flex-shrink-0 animate-pulse-slow">
      ...
      <section className="py-12 lg:py-28 bg-dark">
        <div className="container mx-auto px-4 lg:px-6 max-w-4xl">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="space-y-3 lg:space-y-6">
            {FAQ.map((item, idx) => (
