...
<Helmet>
  ...
  {/* 🌍 الروابط المتبادلة وربط اللغات (Multilingual SEO) */}
  ...
  <link rel="alternate" hreflang="x-default" href="https://www.offfireonline.com/services" />
      ...
      <div className="bg-dark py-16 lg:py-20 text-center px-4 border-b border-white/5 relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto">
            <h1 className="text-2xl md:text-5xl font-black text-text-main mb-4 lg:mb-6 leading-tight max-w-4xl mx-auto text-center">
              {SERVICES_PAGE_CONTENT.hero.title}
            </h1>
            <div className="text-text-sub max-w-3xl mx-auto text-base md:text-xl leading-relaxed mb-8 lg:mb-10 text-center">
          ...
          <div className="space-y-16 lg:space-y-24">
            {SERVICES_PAGE_CONTENT.services.map((service, idx) => (
                <div key={service.id} className={`flex flex-col lg:flex-row gap-8 lg:gap-12 items-start ${idx % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                  ...
                  <div className="w-full lg:w-7/12 relative z-20 ltr:text-left rtl:text-right">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4 mb-6 lg:mb-8">
                        {service.subItems.map((item, i) => (
                            <div key={i} className="bg-card p-4 lg:p-5 rounded-xl lg:rounded-2xl border border-white/5 hover:border-primary/30 transition-colors flex flex-col items-start">
                    ...
                    <div className="p-4 lg:p-6 bg-cta/5 border-s-4 border-cta rounded-e-lg lg:rounded-e-xl mb-6 lg:mb-8 backdrop-blur-sm relative overflow-hidden text-start">
                    ...
                    <Link to="/contact" className="inline-block w-full sm:w-auto">
                        <Button primary className="w-full sm:w-auto text-base lg:text-lg py-3">
        ...
        <div className="container mx-auto px-4 lg:px-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-6">
                {SERVICES_PAGE_CONTENT.usp.map((item, i) => {
                    ...
                    return (
                        <div key={i} className="bg-card p-4 lg:p-6 rounded-xl lg:rounded-2xl border border-white/5 hover:-translate-y-2 transition-transform duration-300 text-start flex flex-col items-start h-full">
      ...
      <section className="py-12 lg:py-20 bg-darker relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-6 relative z-10">
            <div className="mb-8 lg:mb-16 text-center lg:text-start">
            ...
            <div className="relative">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 lg:gap-8">
                    {SERVICES_PAGE_CONTENT.steps.map((step, i) => (
                        <div key={i} className={`relative z-10 bg-dark p-4 lg:p-6 rounded-xl lg:rounded-2xl border border-white/10 hover:border-primary transition-colors text-start group ${i === 4 ? 'col-span-2 lg:col-span-1 w-2/3 mx-auto lg:w-auto' : ''}`}>
      ...
      <section className="py-12 lg:py-20 bg-gradient-to-r from-primary/10 to-cta/10 border-t border-white/10">
        <div className="container mx-auto px-4 lg:px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 lg:gap-6 justify-center">
                <Link to="/contact">
                  <Button primary className="w-full sm:w-auto text-sm lg:text-lg px-8 py-3 shadow-lg shadow-cta/20">
