...
export const HERO_SLIDES = [
  {
    id: 1,
    image: hero1,
    title: "دليلك الرقمي لخدمات الأمن والسلامة في السعودية",
    subtitle: "أنجز متطلبات بوابة سلامة في مكان واحد. اعتمد مخططاتك، ركّب أنظمة الإطفاء، واستلم رخصتك.",
...
export const PAIN_POINTS = [
  ...
  { 
    icon: Clock, 
    title: "استنزاف الوقت", 
    desc: "مماطلة مستمرة في التنفيذ، والخوف من خسارة دفعاتك المقدمة مع شركات غير معتمدة، لتضطر للبحث من جديد ودفع التكلفة مرتين." 
  },
  { 
    icon: FileText, 
    title: "عروض مبهمة", 
...
export const FEATURES = [
  { 
    ...
    desc: "نوصلك فوراً بشركات ومكاتب هندسية معتمدة من الدفاع المدني في جميع مناطق المملكة — بدون وسطاء أو عمولات خفية." 
  },
  { 
  ...
  { 
    ...
    desc: "إرشاد دقيق يضمن التنفيذ وفق كود البناء السعودي ومتطلبات الدفاع المدني، لضمان قبول المخططات واستخراج الرخصة بلا عقبات." 
  },
  { 
...
export const SERVICES_SUMMARY = [
  { 
    ...
    desc: "إعداد واعتماد المخططات الهندسية لأنظمة السلامة والوقاية من الحريق بما يتطابق مع كود البناء السعودي ومتطلبات الدفاع المدني، لضمان قبولها من المرة الأولى.", 
    icon: Zap, 
    image: serviceFire 
  },
  { 
    ...
    desc: "تنفيذ وتركيب كافة أنظمة الإطفاء والإنذار المبكر عبر مقاولين معتمدين، مع الالتزام بأعلى معايير الجودة لضمان اجتياز التفتيش واستخراج شهادة الإنجاز بسلاسة.", 
    icon: ShieldCheck, 
    image: serviceEquip 
  },
  { 
    ...
    desc: "إصدار عقود صيانة معتمدة إلكترونياً عبر بوابة سلامة، لضمان استمرارية عمل الأنظمة بكفاءة، وتسهيل إجراءات تجديد رخصة الدفاع المدني السنوية أو رخصة البلدية.", 
    icon: FileText, 
    image: serviceConsult 
  },
  { 
    id: 4, 
    title: "المتجر الإلكتروني للمعدات", 
    desc: "شراء مباشر لمهمات الأمن والسلامة من موردين موثوقين بأسعار تنافسية، مع توريد فوري لموقع مشروعك لضمان عدم تعطل سير العمل .", 
    icon: Users, 
    image: serviceAlarm 
  }
];
...
export const TARGET_AUDIENCE = [
  { 
    ...
    desc: "(المصانع، المستودعات، والورش):أنظمة متطورة لإدارة المخاطر العالية وحماية خطوط الإنتاج والأصول؛ مع ضمان اجتياز التفتيش الصناعي الصارم لاستمرارية أعمالك.",
    image: serviceEquip 
  },
  { 
    title: "الرعاية الصحية والمستشفيات", 
    desc: "(المستشفيات، العيادات، والمختبرات): تنفيذ أنظمة إطفاء متقدمة لحماية الأرواح والأجهزة الطبية الحساسة، بامتثال تام لأعقد اشتراطات الكود السعودي (SBC).",
    image: serviceFire 
  },
  { 
    title: "القطاع التجاري والإداري", 
    desc: "(المولات، المعارض، والفنادق): مطابقة دقيقة لاشتراطات الدفاع المدني والبلدية؛ لتسهيل استخراج وتجديد رخصتك التجارية دون أي تعطيل لتدفق الزوار والعمليات.",
    image: serviceAlarm 
  },
  { 
    title: "المطورون العقاريون والمقاولون", 
    desc: "شريكك الاستراتيجي لتنفيذ واعتماد بند الإنذار والإطفاء بالكامل، لضمان تسليم مشاريعك للجهات المالكة في وقتها وتجنب غرامات إعادة العمل.",
    image: serviceConsult 
  }
];
...
export const WHY_US = [
  ...
  { 
    ...
    desc: " تحليل فني محايد يحول رحلة البحث من أسابيع إلى دقائق، لضمان الاختيار الأدق بأقل مجهود.", 
    icon: Cpu 
  },
  { 
  ...
  { 
    ...
    desc: "تقييم فني مدروس ومساعدة فورية في تطبيق معايير السلامة دون أي رسوم إضافية.", 
    icon: Coins 
  },
  { 
    title: "دعم فوري", 
  ...
  { 
    ...
    desc: "وصول فوري ودائم للشركات والعمالة المعتمدة رسمياً، لتجنب فخ المقاولين غير المؤهلين.", 
    icon: Filter 
  }
];
...
export const ABOUT_DATA = {
  hero: {
    title: "أول وجهة رقمية سعودية تختصر وتُؤمّن رحلة الأمن  والسلامة لمنشأتك.",
