...
// ... (باقي البيانات كما هي: NAV_LINKS, HERO_SLIDES, PAIN_POINTS, FEATURES, SERVICES_SUMMARY, DETAILED_SERVICES, TARGET_AUDIENCE, WHY_US, FAQ, ABOUT_DATA, BLOG_TAGS, BLOG_CATEGORIES) ...
// === تأكد من نسخ الأجزاء السابقة كما كانت ===
...
export const DETAILED_SERVICES = [
  {
    ...
    details: ["أنظمة الإطفاء المائية (شبكات الرش الآلي، مضخات UL/FM).", "أنظمة الإطفاء بالغاز (FM200، CO2، الأيروسول).", "أنظمة الإنذار الآلي (المعنونة والتقليدية)."],
  ...
  },
  {
    ...
    details: ["طفايات الحريق (بودرة، CO2، رغوة) ومستلزمات الوقاية (PPE).", "إكسسوارات الأنظمة (محابس، خراطيم، كاشفات).", "لوحات الطوارئ ومخارج الهروب."],
  ...
  },
  {
    ...
    details: ["شهادة سلامة (تصريح تشغيل فوري).", "التقرير الفني الهندسي (Technical Report).", "عقود الصيانة الإلكترونية.", "شهادة إنهاء التركيبات وشهادة سلامة التمديدات الكهربائية."],
  ...
  },
  {
    ...
    details: ["اعتماد المخططات (Safety Plans) ومطابقتها للكود السعودي.", "تقييم عروض الأسعار (خدمة حصرية ومجانية).", "دراسات تحليل المخاطر (Risk Assessment)."],
